package com.guoyasoft.gyautotest.api.gyApi.testCase.user;

import com.guoyasoft.gyautotest.api.gyApi.bean.changePwd.ChangePwdReq;
import com.guoyasoft.gyautotest.api.gyApi.bean.changePwd.ChangePwdResp;
import com.guoyasoft.gyautotest.api.gyApi.bean.user.login.LoginReq;
import com.guoyasoft.gyautotest.api.gyApi.bean.user.login.LoginResp;
import com.guoyasoft.gyautotest.api.gyApi.bean.user.signUp.SignUpReq;
import com.guoyasoft.gyautotest.api.gyApi.bean.user.signUp.SignUpResp;
