package com.guoyasoft.gyautotest.api.gyApi.bean.order;
...
public class AddOrderReq {
  ...
  public double getOrdeerPrice() {
    return ordeerPrice;
  }

  public void setOrdeerPrice(double ordeerPrice) {
